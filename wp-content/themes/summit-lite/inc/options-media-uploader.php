...
if ( ! function_exists( 'summit_optionsframework_uploader' ) ) :

function summit_optionsframework_uploader( $_id, $_value, $_desc = '', $_name = '' ) {
...
if ( ! function_exists( 'summit_optionsframework_media_scripts' ) ) :

add_action( 'admin_enqueue_scripts', 'summit_optionsframework_media_scripts' );

function summit_optionsframework_media_scripts( $hook ) {
	...
	wp_localize_script( 'of-media-uploader', 'summit_optionsframework_l10n', array(
